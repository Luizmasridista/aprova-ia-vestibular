    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8">
          ...
          <h1 className="text-3xl font-bold text-center text-gray-900 mb-2">APROVA.AE</h1>
          <p className="text-center text-gray-600 mb-8">Sua plataforma de estudos para o ENEM e vestibulares</p>
